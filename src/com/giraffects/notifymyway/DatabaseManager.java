...
public class DatabaseManager {
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			db.beginTransaction();
			DatabaseManager.createVibrationPattern("Quarter Second Buzz",
					"0,250", db);
			DatabaseManager.createVibrationPattern("Half Second Buzz", "0,500",
					db);
			DatabaseManager.createVibrationPattern("One Second Buzz", "0,1000",
					db);
			DatabaseManager.createVibrationPattern("Two Second Buzz", "0,2000",
					db);
			DatabaseManager.createVibrationPattern("Three Second Buzz",
					"0,3000", db);
			DatabaseManager.createVibrationPattern("Four Second Buzz",
					"0,4000", db);
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			StaticHelper
					.w("Upgrading database from version " + oldVersion + " to "
